...
UPDATE usuarios SET id_rol = 1 WHERE edad < 25;
UPDATE usuarios SET id_rol = 2 WHERE edad BETWEEN 25 AND 29;
UPDATE usuarios SET id_rol = 3 WHERE edad BETWEEN 30 AND 33;
UPDATE usuarios SET id_rol = 4 WHERE edad > 33;

SELECT id_usuario, nombre, edad, id_rol FROM usuarios;
...
-- PASO 3
UPDATE usuarios SET id_categoria = 1 WHERE id_usuario IN (3, 7, 12, 13, 18, 19, 20);
...
LEFT JOIN categorias
    ON usuarios.id_categoria = categorias.id_categorias;
...
-- PASO 3
-- ESTE EJERCICIO VUELVE A PEDIR LO MISMO QUE PASO 4 DE LA 
-- SEGUNDA PARTE??
